...
},{"./is-function":9,"./is-object":10,"./request-base":11,"./response-base":12,"./should-retry":13,"component-emitter":1}],9:[function(require,module,exports){
/**
...
exports.default = {
  init: function init(debug) {
    if (Modernizr.cssanimations) {
      ...
      if (this.isMobile === false) {
        _helpers2.default.addClass(document.documentElement, 'waypoint-animations-enabled');
        this.setupWaypointAnimations();
      }
    }
  },
  setupAnimationCompleteTracking: function setupAnimationCompleteTracking() {
    var animations = [{
      name: 'hero',
      selector: '.c-hero',
      childSelectors: ['.c-hero__header', '.c-quote--hero', '.c-hero__image-wrapper'],
      completeClass: 'hero-animation-complete',
      progressClass: 'hero-animation-in-progress'
    }, {
      name: 'initial-updates',
      selector: '.c-updates',
      childSelectors: ['.c-updates__item'],
    ...
    for (var i = 0; i < animations.length; i++) {
      ...
      if (element !== null) {
        var animationTotal = this.getNumberOfAnimationEvents(element, animations[i].childSelectors);
        if (animationTotal > 0) {
          this.setupAnimationCompleteEvent(element, animationTotal, animations[i].progressClass, animations[i].completeClass);
        }
      }
    }
  },
  setupAnimationCompleteEvent: function setupAnimationCompleteEvent(element, total, progressClass, completeClass) {
    var _this = this;

    var animationCount = 0;

    _helpers2.default.animationEventListener(element, 'AnimationEnd', function () {
      if (animationCount === 0) {
        _helpers2.default.addClass(document.documentElement, progressClass);
      }
      ...
      if (animationCount === total) {
        ...
        _helpers2.default.addClass(document.documentElement, completeClass);
        _helpers2.default.removeClass(document.documentElement, progressClass);
      }
    });
  },
  getNumberOfAnimationEvents: function getNumberOfAnimationEvents(root, childSelectors) {
    var animationCount = 0;

    for (var i = 0; i < childSelectors.length; i++) {
      var elements = root.querySelectorAll(childSelectors[i]);
  ...
  setupWaypointAnimations: function setupWaypointAnimations() {
    ...
    for (var i = 0; i < waypointAnimations.length; i++) {
      this.addWaypointAnimation(waypointAnimations[i]);
    }
  },
  addWaypointAnimation: function addWaypointAnimation(options) {
  ...
  waypointAnimationHandler: function waypointAnimationHandler(direction, animationClass, element) {
    if (direction === 'down') {
      if (this.debug) {
        console.log('Waypoint triggered');
      }

      _helpers2.default.addClass(element, animationClass);
    }
  }
};

},{"../helpers/helpers":22,"ismobilejs":2,"waypoints/lib/noframework.waypoints.js":15}],17:[function(require,module,exports){
'use strict';
...
var GrayscaleSVGFallback = function () {
  ...
  function GrayscaleSVGFallback(parent, el, id) {
    _classCallCheck(this, GrayscaleSVGFallback);
  ...
  _createClass(GrayscaleSVGFallback, [{
    key: 'addFilterSVG',
    value: function addFilterSVG() {
      this.parent.filterAdded = true;
      var filterSVG = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="0" height="0" style="position:absolute">\n        <defs><filter id="gray"><feColorMatrix type="saturate" values="0"/></filter></defs></svg>';
    ...
    value: function switchImage() {
      var svgString = this.generateSVGString(this.el, this.id);
      var svgNode = this.generateNode(svgString);
      this.el.parentNode.replaceChild(svgNode, this.el);
    }
  }, {
    key: 'generateNode',
    value: function generateNode(string) {
      var parent = document.createElement('div');
      parent.innerHTML = string;
      return parent.querySelector('.' + this.wrapperClass);
    }
  }, {
    key: 'generateSVGString',
    value: function generateSVGString(el, id) {
      var title = el.getAttribute('alt');
      if (title.length === 0) {
        title = 'Grayscale Image ' + id;
      }
      var titleEl = '<title id="gray-title-' + id + '">' + title + '</title>';
      var labelledByAttr = ' aria-labelledby="gray-title-' + id + '"';
      var imageUrl = el.getAttribute('src');
      var imageStyles = this.getComputedStyles(el);
      var imageWidth = this.convertPxToInt(imageStyles.width);
      var imageHeight = this.convertPxToInt(imageStyles.height);
      var background = 'background: transparent url(\'' + imageUrl + '\') top left/contain no-repeat';
    ...
    value: function getComputedStyles(el) {
    ...
    key: 'convertPxToInt',
    value: function convertPxToInt(pxString) {
      return parseInt(pxString.replace('px', ''), 10);
    }
  }]);

  return GrayscaleSVGFallback;
}();

exports.default = GrayscaleSVGFallback;
...
var LoadMore = function () {
  ...
  _createClass(LoadMore, [{
    ...
    key: 'setResultSelectorOption',
    value: function setResultSelectorOption() {
      if (this.options.resultSelector === false) {
        var resultSelector = this.container.getAttribute('data-results-selector');
    ...
    key: 'checkNotLast',
    value: function checkNotLast() {
      var notLastPage = void 0;
      ...
      if (this.activePage !== this.numberOfPages) {
        ...
        _helpers2.default.removeClass(this.container, this.options.loadMoreActiveClass);
    ...
    key: 'insertLoadMore',
    value: function insertLoadMore() {
      var content = document.createTextNode('Load more');
    ...
    value: function ajaxRequest() {
      ...
      var requestPage = this.activePage + 1;
      var requestUrl = this.getRequestUrl(requestPage);
      this.log('Starting ajax request for page ' + requestPage);
      if (requestUrl) {
        request.get(requestUrl).query(this.getRequestData(requestPage)).set('Accept', this.getResponseType()).end(function (err, res) {
          if (_this2.options.debug) {
            setTimeout(function () {
              _this2.ajaxComplete(res, err);
            }, _this2.options.renderDelay);
          } else {
            _this2.ajaxComplete(res, err);
          }
        });
    ...
    key: 'ajaxComplete',
    value: function ajaxComplete(res, err) {
    ...
    key: 'getRequestUrl',
    value: function getRequestUrl(requestPage) {
      var requestUrl = false;

      if (this.options.json) {
        requestUrl = this.options.route;
      } else {
        var pageLink = this.paginationLinks[requestPage - 1];
    ...
    key: 'getRequestData',
    value: function getRequestData(requestPage) {
    ...
    key: 'renderJSONResults',
    value: function renderJSONResults(text) {
      this.log('Render JSON result');
      var json = JSON.parse(text);
      var renderedResults = this.options.renderFunction(json);
    ...
    key: 'renderHTMLResults',
    value: function renderHTMLResults(text) {
      if (this.options.resultSelector) {
        this.log('Render HTML result');
        var html = document.createElement('html');
        html.innerHTML = text;
        var results = html.querySelectorAll(this.options.resultSelector);
        if (results.length > 0) {
    ...
    value: function insertResults(results) {
      var resultFragments = document.createDocumentFragment();
    ...
    value: function beforeInsert() {
      _helpers2.default.removeClass(this.container, this.options.loadingClass);
    ...
    value: function updatePagination(oldPage, newPage) {
      if (this.paginationLinks.length > 0) {
        if (typeof this.paginationLinks[oldPage - 1] !== 'undefined') {
          var oldPageEl = this.paginationLinks[oldPage - 1];
          _helpers2.default.removeClass(oldPageEl, this.options.activePageClass);
        }

        if (typeof this.paginationLinks[newPage - 1] !== 'undefined') {
          var newPageEl = this.paginationLinks[newPage - 1];
    ...
    key: 'scrollToLoadedContent',
    value: function scrollToLoadedContent() {
      (0, _jump2.default)(this.getFirstNewItem());
    }
    ...
    key: 'setNumberOfItems',
    value: function setNumberOfItems() {
      var items = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    ...
    key: 'getFirstNewItem',
    value: function getFirstNewItem() {
      var allItems = this.getAllItems();
      var firstNewItem = allItems[this.numberOfItems + 1];
    ...
    key: 'loadErrored',
    value: function loadErrored(err) {
...
},{"../helpers/helpers":22,"jump.js":3,"raf/polyfill":7,"superagent":8}],19:[function(require,module,exports){
'use strict';
...
var NavPrimary = function () {
  ...
  function NavPrimary() {
    ...
    var elementToToggle = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

    _classCallCheck(this, NavPrimary);
    ...
    value: function toggle(e) {
      ...
      if (this.html !== null) {
        if (this.html.className.indexOf(this.activeClass) === -1) {
          ...
          _helpers2.default.removeClass(this.html, this.activeClass);
        }
      }
    }
  }]);
...
exports.default = NavPrimary;

},{"../helpers/helpers":22}],20:[function(require,module,exports){
'use strict';
...
var NavSecondary = function () {
  ...
  function NavSecondary() {
    var navElement = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;

    _classCallCheck(this, NavSecondary);

    this.navElement = navElement === null ? document.querySelector('.js-nav-secondary') : navElement;
  ...
  _createClass(NavSecondary, [{
    ...
    value: function createToggle() {
      ...
      var toggleElementText = document.createTextNode(this.toggleElementText);
      ...
      this.toggleElement.addEventListener('click', function (e) {
        ...
        if (_this.navElement.className.indexOf(_this.secondaryOpenClass) === -1) {
          _helpers2.default.addClass(_this.navElement, _this.secondaryOpenClass);
        } else {
          _helpers2.default.removeClass(_this.navElement, _this.secondaryOpenClass);
        }
      });
    }
  }]);
...
exports.default = NavSecondary;

},{"../helpers/helpers":22}],21:[function(require,module,exports){
'use strict';
...
var VideoPlayer = function () {
   ...
   */
  function VideoPlayer(videoPlayerEl, key) {
...
var Helpers = {
  video: {
    loadYouTubeAPI: function loadYouTubeAPI(onComplete) {
      this.loadAPI();
  ...
  removeClass: function removeClass(el, cssClass) {
    ...
    var newClass = oldClass.replace(new RegExp('(^|\\b)' + cssClass.split(' ').join('|') + '(\\b|$)', 'gi'), ' ');
  ...
  animationEventListener: function animationEventListener(element, type, callback) {
...
var _navPrimary = require('./components/nav-primary');

var _navPrimary2 = _interopRequireDefault(_navPrimary);

var _navSecondary = require('./components/nav-secondary');
...
var _grayscaleSvgFallback = require('./components/grayscale-svg-fallback');

var _grayscaleSvgFallback2 = _interopRequireDefault(_grayscaleSvgFallback);

var _animations = require('./components/animations.js');
...
var DigiratiWebsite = {
  init: function init() {
    this.debug = false;
    new _navPrimary2.default();
    new _navSecondary2.default();
    this.setupVideoComponents();
    this.setupLoadMore();
    this.setupGrayscaleFallback();
    _animations2.default.init(this.debug);
  },
  setupVideoComponents: function setupVideoComponents() {
    var _this = this;

    this.videoComponents = document.querySelectorAll('.js-video-player');

    if (this.videoComponents.length > 0) {
      _helpers2.default.video.loadYouTubeAPI(function () {
        for (var i = 0; i < _this.videoComponents.length; i++) {
          var el = _this.videoComponents[i];
          new _videoPlayer2.default(el, i);
        }
      });
    }
  },
  setupLoadMore: function setupLoadMore() {
    this.loadMoreAreas = document.querySelectorAll('.js-load-more');

    if (this.loadMoreAreas.length > 0) {
      for (var i = 0; i < this.loadMoreAreas.length; i++) {
        var el = this.loadMoreAreas[i];
        var renderFunction = false;
        var resultSelector = false;
  ...
  renderUpdateJSON: function renderUpdateJSON(json) {
    var resultString = '';

    for (var i = 0; i < json.items.length; i++) {
      var item = json.items[i];
      var tag = typeof item.tag !== 'undefined' && item.tag && item.tag.length > 0 ? '<p class="c-updates__tag">' + item.tag + '</p>' : '';

      var result = '<li class="c-updates__item">\n            ' + tag + '\n            <a class="c-updates__link" href="' + item.link + '">' + item.title + '</a>\n          </li>';
      resultString += result;
    }

    return resultString;
  },
  setupGrayscaleFallback: function setupGrayscaleFallback() {
    var root = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : document;

    var grayscaleElSelectorClass = '.c-content-media__image, .c-video__placeholder';
    if (!Modernizr.cssfilters && Modernizr.inlinesvg && Modernizr.svgfilters || this.debug) {
      var applyGrayscaleTo = root.querySelectorAll(grayscaleElSelectorClass);
      for (var i = 0; i < applyGrayscaleTo.length; i++) {
        var element = applyGrayscaleTo[i];
        new _grayscaleSvgFallback2.default(this, element, i + 1);
      }
    }
  }
}; /* eslint-disable no-new */
